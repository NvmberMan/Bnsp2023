...
@section('content')
    ...
    <form class="max-w-md mx-auto mt-5" action="{{route('daftar.store')}}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="relative z-0 w-full mb-5 group">
            ...
            <p class="mt-1 text-sm text-gray-300" id="file_input_help">SVG, PNG, JPG (MAX.
                2mb).</p>
